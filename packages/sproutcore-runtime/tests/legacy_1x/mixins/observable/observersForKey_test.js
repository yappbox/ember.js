...
var ObservableObject = SC.Object.extend(SC.Observable), get = SC.get;
...
test("should get observers", function() {
  ...
  equals(get(o1.observersForKey('foo'), 'length'), 0, "o1.observersForKey should return empty array");
  ...
  equals(get(observers, 'length'), 2, "o2.observersForKey should return an array with length 2");
